...
#+DESCRIPTION: Gallium v2 keymap for the Corne split keyboard

Gallium v2 keymap (with Colemak punctuation positions for =, . / ;=) for the Corne split keyboard.
...
Straight QWERTY for MOBA/ARPG, with =TAB/LSFT/LCTL= on the outer column and =LALT/SPC/MOBAN= on the left thumbs. Toggle back with =TG(_MOBA)= on the right bottom corner.
